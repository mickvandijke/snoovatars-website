    ...
    <div class="mx-auto p-6 md:w-96 w-full max-w-full">
      <div class="mt-3 text-center">
        ...
        <div class="items-center py-3">
          <button :disabled="!isFormValid() || loading" @click="login" class="px-4 h-12 flex justify-center items-center bg-amber-600 hover:bg-amber-500 disabled:bg-white/5 text-header disabled:text-white/20 font-medium rounded-xl w-full duration-200">
          ...
          <NuxtLink to="/signup" class="block mt-2 px-4 py-2 text-details hover:text-header text-base font-medium rounded-2xl w-full duration-200">
            Create a free account
          </NuxtLink>
          <NuxtLink to="/accountdeletion" class="block mt-2 px-4 py-2 text-details hover:text-header text-base font-medium rounded-2xl w-full duration-200">
            Delete account
          </NuxtLink>
        </div>
      </div>
