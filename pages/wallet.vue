<template>
  <div class="relative flex flex-col items-center w-full">
    ...
    <div class="px-2 py-2 sticky top-[80px] md:top-0 lg:relative flex justify-center gap-2 bg-neutral-900/90 backdrop-blur-lg lg:bg-transparent z-10 w-full overflow-x-hidden drop-shadow-lg lg:shadow-none">
            ...
            <div class="p-2 md:p-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-1 border-t border-neutral-700 w-full">
              <template v-if="groupMethod === 'group'">
                <template v-for="[seriesName, seriesTokens] in Object.entries(sortedWalletTokens(walletTokens))">
                  <div class="p-1 grid grid-cols-8 md:grid-cols-12 w-full border border-neutral-700/50 rounded-lg">
