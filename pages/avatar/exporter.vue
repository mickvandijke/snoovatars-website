<template>
  <div class="px-4 py-12 flex flex-col items-center w-full max-w-sm">
    <input type="text" autocomplete="off" name=“searchTerm” class="input" placeholder='Reddit username. Example: "WarmBiertje".' v-model="user" @keyup.enter.prevent="searchUser">
