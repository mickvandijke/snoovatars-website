  ...
  <div class="py-12 flex flex-col items-center w-full max-w-xl">
    <div class="mx-auto p-5 w-96 max-w-full border-2 border-neutral-700 shadow-lg rounded-2xl bg-neutral-800">
      <div class="mt-3 text-center">
        <h3 class="text-lg leading-6 font-medium text-white">Signup</h3>
        <div class="mt-2 px-4 py-3 overflow-y-auto">
          <div>
            <label for="email" class="block mb-2 text-sm font-medium text-neutral-400 text-left">Email</label>
          ...
          <div class="mt-4">
            <label for="password" class="block mb-2 text-sm font-medium text-neutral-400 text-left">Password</label>
          ...
          <div class="mt-4">
            <label for="repeat-password" class="block mb-2 text-sm font-medium text-neutral-400 text-left">Repeat Password</label>
        ...
        <div class="items-center px-4 py-3">
          <button :disabled="!isFormValid() || loading" @click="register" class="px-4 h-10 flex justify-center items-center bg-sky-500 disabled:bg-gray-500 text-white text-base font-medium rounded-2xl w-full hover:bg-sky-600 disabled:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-green-300 duration-200">
          ...
          <NuxtLink to="/login" class="block mt-2 px-4 py-2 text-white text-base font-medium rounded-2xl w-full duration-200">
...
function isFormValid(): boolean {
  return !emailError() && !usernameError() && !passwordError() && !repeatPasswordError();
}
