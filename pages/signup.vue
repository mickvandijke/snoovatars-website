    ...
    <div class="mx-auto p-6 md:w-96 w-full max-w-full">
      <div class="mt-3 text-center">
        ...
        <div class="items-center py-3">
          <button :disabled="!isFormValid() || loading" @click="register" class="px-4 h-10 flex justify-center items-center bg-amber-600 hover:bg-amber-500 disabled:bg-neutral-800 text-white disabled:text-neutral-400 font-medium rounded-2xl w-full duration-200">
