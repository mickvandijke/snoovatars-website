    ...
    <template v-else>
      ...
      <div id="alert-list" class="mt-12 flex flex-col items-center w-full">
        <div class="flex flex-row items-center w-full">
          ...
          <button @click="openAlertModal" class="ml-auto px-4 py-2 max-w-xs flex flex-row flex-nowrap bg-amber-600 hover:bg-amber-500 text-white font-semibold rounded-2xl duration-200">Create Alert</button>
        </div>
