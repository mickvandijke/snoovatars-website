<template>
  <div class="px-4 md:px-6 py-12 flex flex-col gap-3 text-neutral-200 max-w-2xl">
    <h1>Sponsor RCAX's Development</h1>

    <p>You can sponsor RCAX by renting a advertisement banner. Prices start from $5 a day.</p>

    <p>$5 a day if you want your banner to be one of the maximum 5 advertisement banners. This will mean that your banner will alternate visible time with other advertisement banners.</p>

    <p>$20 a day if you want your banner to be the only advertisement banner.</p>
