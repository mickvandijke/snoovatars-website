<template>
  <div class="flex flex-col items-center min-h-screen">
    ...
    <footer class="bg-neutral-800/50 flex flex-col gap-2 text-sm md:text-lg mt-2 mb-20 md:mb-0 mx-2 px-4 md:px-0 py-4 md:py-0 flex flex-col text-neutral-500 text-center rounded-md md:rounded-none md:w-full">
      <div class="container mx-auto py-4 md:py-16 flex flex-col md:flex-row md:justify-between md:items-center gap-6">
