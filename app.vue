<template>
  <div class="flex flex-col items-center">
    ...
    <div class="bg-neutral-800/50 flex flex-col gap-2 text-sm md:text-md mt-2 mb-20 md:mb-0 mx-2 px-4 md:px-6 py-4 md:py-12 flex flex-col text-neutral-500 text-center rounded-md md:rounded-none md:w-full">
