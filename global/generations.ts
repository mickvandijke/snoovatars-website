export const Filters = {
    ...
    wsb: {
        type: "premium",
        collections: ["0xa3396af20ce52bd3c7ab6d7046be617257f60eb9"]
    },
    recap2022: {
        type: "free",
        collections: ["0xc8d3a3a83bde5dad06d436694e3e22ac3e64d577"]
    },
    blnt: {
        type: "free",
        collections: ["0x006c5e042c01fff6ca0cfd8759313bdcf5ae622d"]
    },
    rabbids: {
        type: "free",
        collections: ["0x5066c0934632bcc2902d139d7c875cbd295429f8"]
    },
    starterpack: {
        type: "free",
        collections: ["0xeb959a715dfffe6f82f4605533982c4859cb14fe"]
    },
    endangered: {
        type: "free",
        collections: ["0xf33ad86bb54a278a6c9f9c076f4ed5a34c531967"]
    },
    awwdripmemesingu: {
        type: "free",
        collections: [
    ...
    cup2022: {
        type: "free",
        collections: ["0x622d8fea4603ba9edaf1084b407052d8b0a9bed7"]
    },
    superbowllvii: {
        type: "free",
...
export function getAllCollections(): string[] {
    ...
    for (const key in Filters) {
        if (Filters.hasOwnProperty(key)) {
            collections.push(...Filters[key].collections);
        }
    }
...
export function getFreeCollections(): string[] {
    const freeCollections: string[] = [];

    // Loop through each property in the Filters object
    for (const key in Filters) {
        if (Filters.hasOwnProperty(key)) {
            const collectionType = Filters[key].type;
            if (collectionType === "free") {
                // Concatenate the "free" collections to the freeCollections array
                freeCollections.push(...Filters[key].collections);
            }
        }
    }
