<template>
  <div class="mt-4 md:mt-24 pb-[53px] md:pb-0 w-full">
    <div class="px-4 md:px-6 py-6 w-full flex flex-col justify-center gap-6 border-t border-tertiary">
      <div class="w-full flex flex-col md:flex-row justify-center items-center gap-3 md:gap-12 text-[0.8rem] text-details font-medium">
        <div class="border-neutral-800/90 w-fit">&copy; 2024 RCAX.</div>
        ...
        <div class="md:ml-auto flex items-center gap-6 md:gap-12">
          <div class="flex items-center gap-3 md:gap-6">
            <a href="https://twitter.com/RCAX_io" class="p-2 md:p-1 flex items-center gap-2 text-header font-semibold">
              <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 248 204">
              <path fill="#1d9bf0" d="M221.95 51.29c.15 2.17.15 4.34.15 6.53 0 66.73-50.8 143.69-143.69 143.69v-.04c-27.44.04-54.31-7.82-77.41-22.64 3.99.48 8 .72 12.02.73 22.74.02 44.83-7.61 62.72-21.66-21.61-.41-40.56-14.5-47.18-35.07 7.57 1.46 15.37 1.16 22.8-.87-23.56-4.76-40.51-25.46-40.51-49.5v-.64c7.02 3.91 14.88 6.08 22.92 6.32C11.58 63.31 4.74 33.79 18.14 10.71c25.64 31.55 63.47 50.73 104.08 52.76-4.07-17.54 1.49-35.92 14.61-48.25 20.34-19.12 52.33-18.14 71.45 2.19 11.31-2.23 22.15-6.38 32.07-12.26-3.77 11.69-11.66 21.62-22.2 27.93 10.01-1.18 19.79-3.86 29-7.95-6.78 10.16-15.32 19.01-25.2 26.16z"/>
            </svg>
            </a>
            <a href="https://discord.gg/6VAVhjMECB" class="p-2 md:p-1 flex items-center gap-2 text-header font-semibold">
              <svg class="w-5 h-5" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><g>
            ...
            <a href="https://www.reddit.com/r/avatartrading/" class="p-2 md:p-1 flex items-center gap-2 text-header font-semibold">
              <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve"><g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)"><circle cx="45" cy="45" r="45" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(255,69,0); fill-rule: nonzero; opacity: 1;" transform="  matrix(1 0 0 1 0 0) "/>
          ...
          <div class="flex items-center gap-3">
            <a class="h-8" href='https://apps.apple.com/nl/app/rcax/id6449831133'><img alt='Download on the App Store' src='/images/branding/appstore.svg' class="h-full w-auto"/></a>
      ...
      <div class="w-full flex justify-start items-center gap-3 text-[0.8rem] text-white/40">
        <span>Developed by</span>
        <a href="https://dutchbits.nl">
          <img class="h-8" src="~/assets/images/logo-dutchbits.svg">
        </a>
      </div>
    </div>
  </div>
