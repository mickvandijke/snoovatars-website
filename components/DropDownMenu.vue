...
<style>
.menu-button--button {
  @apply text-white/90 hover:text-white duration-300;
}
...
.menu-button--menu--item-wrapper > * {
  @apply p-3 w-full whitespace-nowrap inline-flex items-center hover:bg-primary-accent text-white rounded-lg duration-200;
}
</style>
