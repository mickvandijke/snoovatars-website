...
<!--                <img src="/images/banners/nyan_banner_bg.png" alt="Banner Image" class="object-fill object-top" />-->
<!--              </div>-->
<!--              <a href="https://nyanmatcher.xyz/" target="_blank" class="md:hidden absolute top-0 left-0 right-0 bottom-0 z-20"></a>-->
<!--            </div>-->
<!--          </div>-->
<!--        </div>-->
<!--      </Slide>-->
