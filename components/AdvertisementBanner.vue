<template>
  <div v-if="isBannerShowing" class="sm:mb-6 px-2 sm:px-6 w-full h-24 sm:h-96">
    <div class="relative flex items-center justify-center bg-black w-full h-full rounded-lg sm:rounded-2xl">
