      ...
      <AvatarCard :item="{ name: item.series.name, contract_address: item.series.contract_address, image: item.series.image }" :series-stats="item" hide-floor>
        ...
        <div class="flex">
          <template v-if="item.stats.last_sale">
            <div class="flex flex-nowrap items-center gap-1 font-bold text-[0.7rem] overflow-hidden">
        ...
        <div class="flex gap-2 font-medium text-[0.79rem] items-center">
          ...
          <template v-if="item.stats.lowest_listing">
            <div class="ml-auto flex items-center gap-1 font-bold overflow-hidden">
