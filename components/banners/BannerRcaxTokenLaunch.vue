    ...
    <div class="advertisement bg-black">
      <div class="relative p-4 flex gap-12 justify-center items-center w-full h-full overflow-hidden">
        <div class="hidden md:flex justify-center items-center z-20">
          <img src="/images/branding/rcax/RCAX_Round_Color.svg" class="object-contain md:max-h-64 rounded-2xl shadow-xl">
        </div>
        ...
        <a href="https://whitepaper.rcax.io/" target="_blank" class="md:hidden absolute top-0 left-0 right-0 bottom-0 z-30"></a>
      </div>
    </div>
  </div>
</template>
