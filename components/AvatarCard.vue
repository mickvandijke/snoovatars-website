<template>
  <div @click="selectAvatar" ref="componentRef" class="p-2 sm:bg-secondary sm:hover:bg-tertiary relative flex flex-col gap-1 w-full sm:rounded-2xl border-t sm:border-none border-secondary overflow-hidden cursor-pointer duration-300">
