        ...
        <div class="w-full justify-center md:justify-start text-center">
          ...
          <div class="flex items-center justify-center">
            <div class="flex flex-col items-center">
              <a href="https://twitter.com/RCAX_io" class="flex items-center gap-2 text-white font-semibold">
              ...
              <a href="https://discord.gg/6VAVhjMECB" class="flex items-center gap-2 text-white font-semibold">
