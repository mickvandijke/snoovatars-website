        ...
        <div class="flex flex-col">
          <div class="flex gap-2 font-bold text-[0.7rem] items-center">
            <div class="flex gap-1">
              ...
              <template v-if="lowestListing">
                <div class="flex flex-col">
                  <button @click.stop="openLinkWith(`https://opensea.io/assets/matic/${lowestListing.token.contract_address}/${lowestListing.token.id}`)" class="flex items-center gap-0.25">
